...
new class extends Component {
    ...
    {
        return auth()->check() && auth()->user()->following()->where('following_user_id', $this->user->id)->exists();
    }
    ...
    /**
     * Refresh follower count saat follow button di-klik
     */
        ...
        <div class="flex flex-col sm:flex-row gap-8 items-start sm:items-center">
            ...
            <div class="flex-1">
                <div class="flex flex-col sm:flex-row sm:items-center gap-4 mb-4">
                    ...
                    <!-- Follow/Edit Button -->
                    @if (auth()->id() !== $user->id)
                        <livewire:follows.follow-button :user="$user" wire:key="follow-button-{{ $user->id }}" />
                    @else
